...
func _on_DetectEnemy_body_entered(body: Node) -> void:
	if(body.last_damage=="Troll" or body.last_damage=="serpant" or body.last_damage=="bigspider" or body.last_damage=="beholder"):
		body.damage(1)
	elif(body.last_damage=="Mole" and player):
		body.damage(1)
		if(!body.angry):
			body.get_parent().get_mad()
	if(body.last_damage!="Troll" and body.last_damage!="Mole" and body.last_damage!="serpant" and body.last_damage!="bigspider" and body.last_damage!="beholder"):
		body.death()
