...
func _on_Wall_body_entered(body: Node) -> void:
	if(randi()%5==0 and body.name!="Bedrock1" and body.name!="Bedrock2" and body.name!="Bedrock3" and body.name!="Bedrock4" and body.name!="Bedrock5" and body.name!="Bedrock6" and body.name!="Bedrock7" and body.name!="Bedrock8"):
		body.destroy()
	queue_free()
